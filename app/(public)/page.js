  ...
  useEffect(() => {
    const fetchFeatured = async () => {
      try {
        ...
        setFeaturedBands(list.slice(0, 6)); // Show first 6 as featured
      } catch (err) {
        console.error(err);
      }
    };
    ...
    <div className="home-container perspective-container">
      ...
      <section className="experience-gallery container">
        ...
        <div className="gallery-grid">
          <div className="img-wrap reveal delay-1"><img src="https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&q=80&w=600" alt="Gig 1"/></div>
          <div className="img-wrap reveal delay-2"><img src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&q=80&w=600" alt="Gig 2"/></div>
          <div className="img-wrap reveal delay-3"><img src="https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?auto=format&fit=crop&q=80&w=600" alt="Gig 3"/></div>
        </div>
      </section>
