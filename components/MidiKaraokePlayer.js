...
export default function MidiKaraokePlayer({ fileUrl, fileName, initialSongId, songList = [], onClose }) {
  ...
  return (
    <div className="karaoke-overlay">
      ...
      <style jsx>{`
        .karaoke-overlay { position: fixed; inset: 0; z-index: 9999; background: rgba(0,0,0,0.92); -webkit-backdrop-filter: blur(20px); backdrop-filter: blur(20px); display: flex; align-items: center; justify-content: center; animation: fadeIn 0.3s ease; touch-action: pan-y pinch-zoom; overflow: hidden; }
