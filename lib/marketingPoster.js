...
<!-- Heading -->
<text x="${W / 2}" y="${nameY + 300}" text-anchor="middle" font-family="Segoe UI, Arial, Helvetica, sans-serif" font-size="140" font-weight="800" fill="url(#accentGrad)">Naruci pesmu</text>
