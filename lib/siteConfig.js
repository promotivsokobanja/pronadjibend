...
const DEFAULT_CONTACT_INFO = {
  email: 'info@pronadjibend.rs',
  instagram: 'https://www.instagram.com/pronadjibend',
  facebook: 'https://www.facebook.com/pronadjibend',
};
...
export async function setContactInfo({ email, instagram, facebook }) {
  const data = {
